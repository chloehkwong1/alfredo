...
function LifecycleNudge({ onArchiveAllDone, onOpenAutoArchive, onDismiss }: LifecycleNudgeProps) {
  return (
    <div className="mx-3 my-2 flex items-start gap-2 rounded-md border border-[rgba(96,165,250,0.18)] bg-[rgba(96,165,250,0.06)] px-2.5 py-2 text-[11px] text-text-secondary">
      ...
      <div className="flex-1 leading-snug">
        <div>
          <strong className="text-text-primary font-medium">Done with these worktrees?</strong>
        </div>
        <div className="text-text-tertiary mt-0.5">
          Archive to clear them out, or change the lifecycle rules.
        </div>
