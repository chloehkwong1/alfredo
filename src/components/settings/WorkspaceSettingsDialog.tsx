          ...
          <nav className="flex flex-col gap-0.5 w-36 flex-shrink-0 border-r border-border-default pr-4">
            {TABS.map((t) => (
              <button
                ...
                onClick={() => setTab(t.id)}
                className={[
                  "px-3 py-1.5 text-body rounded-[var(--radius-md)] text-left",
            ...
            {tab === "repository" && (
              <div className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-2 rounded-[var(--radius-md)] border border-border-default bg-bg-secondary px-3 h-8 text-body text-text-secondary">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    type="text"
                    className="w-full rounded-[var(--radius-md)] border border-border-default bg-bg-primary px-3 h-8 text-body text-text-primary placeholder:text-text-tertiary focus:outline-none focus:ring-1 focus:ring-accent-primary"
                ...
                <div className="space-y-1.5">
                  ...
                  <span className="text-micro font-medium px-2 py-0.5 rounded-full bg-bg-hover text-text-tertiary">Coming soon</span>
                </div>
              </div>
            )}
